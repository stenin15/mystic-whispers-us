  ...
  return (
    <>
      <section id="offer-section" style={{ position: 'relative', width: '100%', lineHeight: 0 }}>
        ...
        <div className="hidden md:flex absolute" style={{ left: 0, right: 0, top: '58%', height: '24%', zIndex: 5, gap: 3, overflow: 'hidden' }}>
        ...
        {/* Carousel mobile — overflow:hidden garante que setas não saiam */}
        <div
          className="block md:hidden absolute"
          style={{ left: '4%', right: '4%', top: '63%', height: '17%', zIndex: 5, borderRadius: 10, overflow: 'hidden' }}
        >
