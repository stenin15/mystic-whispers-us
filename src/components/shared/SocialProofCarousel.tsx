...
const testimonials = [
  {
    name: 'Carla S.',
    city: 'Rio de Janeiro',
    text: '"Revelou coisas que eu sentia mas não entendia."',
    avatar: avatarCarla,
    rating: 5,
  },
  {
    name: 'Patrícia L.',
    city: 'Belo Horizonte',
    text: '"Me ajudou a tomar uma decisão importante."',
  ...
  },
  {
    name: 'Fernanda A.',
    city: 'Curitiba',
    text: '"Chorei lendo. Muito verdadeiro."',
  ...
  },
  {
    name: 'Eduardo C.',
    city: 'Brasília',
    text: '"Recomendo para quem busca clareza."',
  ...
  },
  {
    name: 'Mariana T.',
    city: 'Porto Alegre',
    text: '"A mensagem veio na hora certa."',
  ...
  },
  {
    name: 'Rafael M.',
    city: 'Salvador',
    text: '"Nunca vi algo tão certeiro assim."',
    avatar: avatarRafael,
    rating: 5,
  },
];
